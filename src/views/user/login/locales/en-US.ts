export default {
  'page.user.login.form-item-username': 'Please input your username',
  'page.user.login.form-item-username.required': 'Please input your username',
  'page.user.login.form-item-password': 'Please input your password',
  'page.user.login.form-item-password.required': 'Please input your password',
  'page.user.login.form-item-imgcode': 'Please input verification code',
  'page.user.login.form-item-imgcode.required': 'Please input verification code',
  'page.user.login.form-item-imgcode.click-tips': 'Click refresh',
