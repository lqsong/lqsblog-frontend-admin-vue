...
<script lang="ts" setup>
    ...
    const props = withDefaults(defineProps<Props>(), {
        title: 'Search'/* t('views.works.list.components.search.title') */
    })
...
<template>
    ...
    >
        ...
        <el-form label-position="top" :model="modelRef" ref="formRef">               
            ...
            <el-form-item :label="t('views.works.list.components.search.form.keywords')" >
                <el-input v-model="modelRef.keywords" :placeholder="t('views.works.list.components.search.form.keywords.placeholder')" />
            </el-form-item>
            <el-form-item :label="t('views.works.list.components.search.form.addtime')">
                <el-date-picker
                    v-model="modelRef.addtime"
                    type="datetimerange"
                    range-separator="—"
                    :start-placeholder="t('views.works.list.components.search.form.addtime.placeholder.start')"
                    :end-placeholder="t('views.works.list.components.search.form.addtime.placeholder.end')"
                    value-format="YYYY-MM-DD HH:mm:ss"
                    class="width-percent100">
                </el-date-picker>
            </el-form-item>
             <el-form-item :label="t('views.works.list.components.search.form.tags')" >
                <tag-select v-model="modelRef.tags" :placeholder="t('views.works.list.components.search.form.tags.placeholder')"  class="width-percent100" > </tag-select>
            </el-form-item>
        </el-form>
        ...
        <template #footer>
            <div class="text-align-right">
                <el-button style="margin-right: 8px" @click="onResetFrom">
                    {{t('views.works.list.components.search.form.button.reset')}}
                </el-button>
                <el-button type="primary" @click="onSearch">
                    {{t('views.works.list.components.search.form.button.primary')}}
                </el-button>
            </div>
        </template>
