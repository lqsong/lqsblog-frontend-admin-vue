    ...
    >
        ...
        <el-table-column
            ...
            <template #default="{row,$index}">
                <router-link :to="`/article/edit?id=${row.id}`" class="el-button el-button--text el-button--small text-decoration-none">{{t('views.article.list.table.column.action.buttion.edit')}}</router-link>
