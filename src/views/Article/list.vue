<template>
    <div class="main-conent main-conent-screen main-conent-bgFFF main-conent-borderradius">
            <div class="screen-header">
                <el-row>
                    <el-col :span="8">
                        <router-link to="/article/add" class="el-button el-button--primary el-button--small text-decoration-none"><svg-icon icon-class="button-add" /> 新增</router-link>
                    </el-col>
               ...
               :data="tableData">
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <router-link :to="`/article/edit-${scope.row.id}`" class="el-button el-button--text el-button--small text-decoration-none">修改</router-link>
...
<script>
import { ArticleList, ArticleDel } from '@/service/article';
    ...
    methods: {
        ...
        getList() {
            ...
            const paramData = {
                ...
                categoryid: [..._this.searchCategory].pop(),
