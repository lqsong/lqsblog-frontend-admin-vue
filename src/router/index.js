...
// 引入对应模块路由
import articleRouter from '@/router/modules/article'; // 文章
import worksRouter from '@/router/modules/works'; // 作品
import topicsRouter from '@/router/modules/topics'; // 专题
import linksRouter from '@/router/modules/links'; // 左邻右舍
import settingRouter from '@/router/modules/setting'; // 设置
    ...
    children: [
      {
        ...
        name: 'home',
        meta: { title: '控制台', activeMenu: '/', belongTopMenu: '/' }
      }
    ]
  }
